...
BOT_TOKEN = environ.get('BOT_TOKEN', "6142764342:AAEse04SqQ1DX9fd4GNAOOF-A5jLD_ieyKY")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', 'ghostiermas_chat, -1001879728449, -1001866916365').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ghostier:ghostier@filter-bot.jdwubv9.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "filter-bot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Channel Button Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ghostiermas_chat')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ghostiermas')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/nyagwenchar')
MSG_ALRT = environ.get('MSG_ALRT', 'Share and Support Us')

# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', ))
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001879728449))
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 't.me/ghostiermas')
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/cynitemovies/3')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001662448231))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001662448231))
